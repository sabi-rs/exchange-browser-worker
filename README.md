...
PYTHONPATH=src python -m smarkets_automation.cli show-market --event-url "https://smarkets.com/event/44407959/sport/football/england-premier-league/2025/05/11/15-30/liverpool-vs-arsenal"
PYTHONPATH=src python -m smarkets_automation.cli place-bet --event-url "https://smarkets.com/event/44407959/sport/football/england-premier-league/2025/05/11/15-30/liverpool-vs-arsenal" --contract Arsenal --side buy --stake 10
PYTHONPATH=src python -m smarkets_automation.cli place-bet --event-url "https://smarkets.com/event/44407959/sport/football/england-premier-league/2025/05/11/15-30/liverpool-vs-arsenal" --contract Arsenal --side buy --stake 10 --confirm
```
...
- `place-bet` resolves available contracts from the live market snapshot so contract selection still fails closed.
